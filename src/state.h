...
struct TUT4__state {
  ...
  */
  ...
  /**
  * Given a struct TUT4__state, this function serializes it into given output buffer.
  * @param self              pointer to source struct TUT4__state
  ...
  */
  ...
  /**
  * Given a struct TUT4__state, this function serializes it into given mpack writer.
  * @param self              pointer to source struct TUT4__state
...
/**
 * Initializes struct struct TUT4__state. empties fields, sets function pointers
 * @param self  struct TUT4__state
 */
void TUT4__state_init(struct TUT4__state *self);


/* ORIGINAL SCHEMA
{"$schema"=>"http://json-schema.org/draft-04/schema#", "id"=>"state", "title"=>"Device state", "description"=>"", "type"=>"object", "properties"=>{"switch_on"=>{"type"=>"boolean"}, "led1"=>{"type"=>"string", "maxLength"=>3}}, "required"=>["switch_on", "led1"]}
 */
#endif		//tut4_STATE_H
