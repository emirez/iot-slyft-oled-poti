...
void TUT4__config_parse_next(struct TUT4__config *self, mpack_reader_t *reader) {
...
int TUT4__config_parse(struct TUT4__config *self, const uint8_t *input_buf, size_t sz_input_buf) {
    ...
    self->TUT4__config_parse_mpack(self, &reader);
...
void TUT4__config_parse_mpack(struct TUT4__config *self, mpack_reader_t *reader) {
    ...
    for (int i = 0; i < count; i++) {
        TUT4__config_parse_next(self, reader);
    }
...
size_t TUT4__config_serialize(const struct TUT4__config *self, uint8_t *output_buf, size_t sz_output_buf) {
    ...
    mpack_writer_init(&writer,(char*)output_buf,sz_output_buf);
		...
		self->TUT4__config_serialize_mpack(self, &writer);
...
void TUT4__config_init(struct TUT4__config *self) {
    self->TUT4__config_clean = &TUT4__config_clean;
    self->TUT4__config_parse = &TUT4__config_parse;
    self->TUT4__config_parse_mpack = &TUT4__config_parse_mpack;
    self->TUT4__config_serialize = &TUT4__config_serialize;
    self->TUT4__config_serialize_mpack = &TUT4__config_serialize_mpack;
    self->TUT4__config_clean(self);
}
